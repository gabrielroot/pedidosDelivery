...
Revision ID: 88f391af2597
Revises: 
Create Date: 2021-03-02 18:15:19.582667
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('item_id', 'flavor_id')
    )
    op.create_index(op.f('ix_flavorItem_deleted_at'), 'flavorItem', ['deleted_at'], unique=False)
...
def downgrade():
    ...
    op.drop_table('order')
    op.drop_index(op.f('ix_flavorItem_deleted_at'), table_name='flavorItem')
    op.drop_table('flavorItem')
